...
HW_Script_SetSpecSn()
{		
	echo $var_boardinfo_file | xargs sed 's/obj.id = \"0x00000019\" ; obj.value = \"[A-Za-z0-9-]*\"/obj.id = \"0x00000019\" ; obj.value = \"'$var_specsn'\"/g' -i
	return
}
...
HW_Script_SetDatToFile()
{
    ...
    then
        ...
        # set ssid2 
    cfgtool set $var_default_ctree $var_node_ssid2 SSID "VIDEOPHONE_$var_para"
    if [ 0 -ne $? ]
    then
